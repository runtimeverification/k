...
def llvm_interpret(definition_dir: str | Path, pattern: Pattern, *, depth: int | None = None) -> Pattern:
    ...
    :param definition_dir: Path to the kompiled definition directory
    :param pattern: KORE pattern to start rewriting from
    :param depth: Maximal number of rewrite steps to take
