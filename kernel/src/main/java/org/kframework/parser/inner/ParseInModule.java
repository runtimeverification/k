...
public class ParseInModule implements Serializable, AutoCloseable {
    ...
    public ParseInModule(Module seedModule) {
        this(seedModule, seedModule, seedModule, seedModule, null, true, null, false, false);
    }

    public ParseInModule(Module seedModule, boolean strict, TimingCollector timing, boolean isBison, boolean forGlobalScanner) {
        this(seedModule, null, null, null, null, strict, timing, isBison, forGlobalScanner);
    }

    public ParseInModule(Module seedModule, Scanner scanner, boolean strict, TimingCollector timing, boolean isBison, boolean forGlobalScanner) {
        this(seedModule, null, null, null, scanner, strict, timing, isBison, forGlobalScanner);
    }

    public ParseInModule(Module seedModule, Module extensionModule, Module disambModule, Module parsingModule, Scanner scanner, boolean strict, TimingCollector timing, boolean isBison, boolean forGlobalScanner) {
    ...
    private Tuple2<Either<Set<KEMException>, Term>, Set<KEMException>>
        ...
        try {
            ...
            if (timing != null) {
                ...
                timing.addMessage(String.format("%5d %s:%d   parse:%4d typeInf:%4d", totalTime, source.source(), startLine, parseTime, tiTime),
