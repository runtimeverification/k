...
public class GenericToken extends Token {
    /* Token cache */
    private static Map<GenericToken, GenericToken> tokenCache
            = new HashMap<GenericToken, GenericToken>();
    /* KApp cache */
     ...
     * @param sort different than #Bool, #Int, or #String
     * @param value
     * @return
     */
    ...
    /**
     * Returns a {@link KApp} representing a {@link GenericToken} of the given sort with the given
