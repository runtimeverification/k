...
public class CommandlineOptions {
	...
	public void initializeKRunOptions() {
        ...
        Option testgen = OptionBuilder.hasArg(false).withArgName("STRING").withLongOpt("testgen").withDescription("Test programs will be generated along with normal search").create();
