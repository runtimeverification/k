...
public abstract class BaseTest {
  ...
  private static final String COPYRIGHT_HEADER =
      "// Copyright (c) "
          ...
          + " K Team. All Rights Reserved.";
  private static final String COPYRIGHT_HEADER_REGEX =
      "// Copyright \\(c\\) [0-9\\-]* K Team. All Rights Reserved.";
  ...
  private void testConversion(Function<File, DefinitionWithContext> parse) throws IOException {
    ...
    File kilExpectedDefinitionFile =
        testResource("/convertor-tests/" + name.getMethodName() + expectedFilePostfix());
    ...
    if (forceFixAssertionFiles) {
      ...
      String expectedOutput =
          FileUtils.readFileToString(kilExpectedDefinitionFile).replaceAll("\r\n", "\n");
