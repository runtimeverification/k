...
public class CommandlineOptions {
	...
	public void initializeKRunOptions() {
		...
		Option output_mode = OptionBuilder.hasArg(true).withArgName("STRING").withLongOpt("output-mode").withDescription("How to display Maude results (none, raw," + K.lineSeparator + "pretty, xml)").create();
