...
import org.kframework.kompile.BubbleParsing;
...
public class RuleGrammarTest {
    private final static Sort startSymbol = BubbleParsing.START_SYMBOL;
    ...
    private void parseRule(String input, String def, int warnings, K expectedResult) {
        Module test = ParserUtils.parseMainModuleOuterSyntax(def, Source.apply("generated by RuleGrammarTest"), "TEST");
        ParseInModule parser = gen.getCombinedGrammar(gen.getRuleGrammar(test));
        Tuple2<Either<Set<ParseFailedException>, K>, Set<ParseFailedException>> rule
