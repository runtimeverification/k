...
class ConfigArgs:
    ...
    def config_args(self) -> ArgumentParser:
        ...
        args.add_argument(
            ...
            dest='config_file',
            type=file_path,
            default=Path('./pykframework.toml'),
            help='Path to pykframework config file.',
        )
        args.add_argument(
            '--config-profile',
            dest='config_profile',
...
class KCLIArgs:
    ...
    def warning_args(self) -> ArgumentParser:
        ...
        args.add_argument(
            ...
            dest='warnings',
            type=Warnings,
            help='Warnings to print about (no effect on pykframework, only subcommands).',
        )
        args.add_argument(
            '--warnings_to_errors',
            '-w2e',
            ...
            default=None,
            action='store_true',
            help='Turn warnings into errors (no effect on pykframework, only subcommands).',
        )
        return args
