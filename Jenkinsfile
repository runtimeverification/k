            ...
            stage('Build on Mac OS') {
              stages {
                ...
                stage("Test Homebrew Bottle") {
                  ...
                  steps {
                    dir('homebrew-k') {
                      git url: 'git@github.com:kframework/homebrew-k.git', branch: 'brew-release-${env.PACKAGE}'
                      unstash "mojave"
                      sh '''
    ...
    stage('Deploy') {
      ...
      steps {
        ...
        sh '''
          ...
          BOTTLE_NAME=`echo kframework--5.0.0.mojave.bottle*.tar.gz | sed 's!kframework--!kframework-!'`
