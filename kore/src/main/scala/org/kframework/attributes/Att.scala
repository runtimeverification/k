...
object Att {
  ...
  final val LEFT_INTERNAL        = Key.internal("left", KeyRange.FrontendOnly)
  ...
  final val PRIORITIES         = Key.internal("priorities", KeyRange.FrontendOnly)
  ...
  final val RIGHT_INTERNAL     = Key.internal("right", KeyRange.FrontendOnly)
  ...
  final val TERMINALS            = Key.internal("terminals", KeyRange.FrontendOnly)
