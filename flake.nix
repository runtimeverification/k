{
  ...
  inputs = {
    ...
    haskell-backend.url = "github:runtimeverification/haskell-backend/1da6c43b8bb74a231b58978b1964a45d7ca753e4";
    booster-backend = {
      url = "github:runtimeverification/hs-backend-booster/8cab8f390423ac4bc9be03ef3dc50cfdfb02ba08";
