...
- [Syntax Declaration](#syntax-declaration)
  - [Named Non-Terminals](#named-non-terminals)
  - [`klabel(_)` and `symbol` attributes](#klabel_-and-symbol-attributes)
  - [Parametric productions and `bracket` attributes](#parametric-productions-and-bracket-attributes)
  - [`function` and `functional` attributes](#function-and-functional-attributes)
  - [`freshGenerator` attribute](#freshgenerator-attribute)
  - [`token` attribute](#token-attribute)
  - [Converting between `token` sorts](#converting-between-token-sorts)
  - [Parsing comments, and the `#Layout` sort](#parsing-comments-and-the-layout-sort)
  - [`prec` attribute](#prec-attribute)
  - [`unused` attribute](#unused-attribute)
  - [Symbol priority and associativity](#symbol-priority-and-associativity)
  - [Lexical identifiers](#lexical-identifiers)
  - [`assoc`, `comm`, `idem`, and `unit` attributes](#assoc-comm-idem-and-unit-attributes)
- [Configuration Declaration](#configuration-declaration)
  - [`exit` attribute](#exit-attribute)
  - [Collection Cells: `multiplicity` and `type` attributes](#collection-cells-multiplicity-and-type-attributes)
- [Rule Declaration](#rule-declaration)
  - [Pattern Matching operator](#pattern-matching-operator)
  - [Anonymous function applications](#anonymous-function-applications)
  - [Macros and Aliases](#macros-and-aliases)
  - [`anywhere` rules](#anywhere-rules)
  - [`smt-lemma`, `lemma`, and `trusted` attributes](#smt-lemma-lemma-and-trusted-attributes)
  - [Projection and Predicate functions](#projection-and-predicate-functions)
  - [`simplification` attribute (Haskell backend)](#simplification-attribute-haskell-backend)
  - [`concrete` attribute, `#isConcrete` and `#isVariable` function (Java backend)](#concrete-attribute-isconcrete-and-isvariable-function-java-backend)
  - [`concrete` and `symbolic` attributes (Haskell backend)](#concrete-and-symbolic-attributes-haskell-backend)
  - [The `unboundVariables` attribute](#the-unboundvariables-attribute)
  - [The `memo` attribute](#the-memo-attribute)
    - [Limitations of memoization with the Haskell backend](#limitations-of-memoization-with-the-haskell-backend)
  - [Variable Sort Inference](#variable-sort-inference)
  - [Casting](#casting)
  - [Semantic casts](#semantic-casts)
  - [Strict casts](#strict-casts)
  - [Projection casts](#projection-casts)
  - [`owise` and `priority` attributes.](#owise-and-priority-attributes)
- [Evaluation Strategy](#evaluation-strategy)
  - [`strict` and `seqstrict` attributes](#strict-and-seqstrict-attributes)
  - [Context Declaration](#context-declaration)
  - [Side conditions in context declarations](#side-conditions-in-context-declarations)
  - [Rewrites in context declarations](#rewrites-in-context-declarations)
  - [`result` attribute](#result-attribute)
  - [`hybrid` attribute](#hybrid-attribute)
  - [Context aliases](#context-aliases)
- [Pattern Matching](#pattern-matching)
  - [As Patterns](#as-patterns)
  - [Record-like KApply Patterns](#record-like-kapply-patterns)
  - [Or Patterns](#or-patterns)
  - [Matching global context in function rules](#matching-global-context-in-function-rules)
  - [Collection patterns](#collection-patterns)
  - [Matching on cell fragments](#matching-on-cell-fragments)
  - [`all-path` and `one-path` attributes to distinguish reachability claims](#all-path-and-one-path-attributes-to-distinguish-reachability-claims)
  - [Set Variables](#set-variables)
    - [Motivation](#motivation)
    - [Syntax](#syntax)
    - [Example](#example)
    - [SMT Translation](#smt-translation)
    - [Caution](#caution)
  - [Variables occurring only in the RHS of a rule](#variables-occurring-only-in-the-rhs-of-a-rule)
    - [Summary](#summary)
    - [Introduction](#introduction)
    - [Example: Verification claims](#example-verification-claims)
    - [Example: Random Number Construct `rand()`](#example-random-number-construct-rand)
    - [Example: Fresh Integer Construct `fresh(Is)`](#example-fresh-integer-construct-freshis)
    - [Example: Arbitrary Number (Unspecific Function) `arb()`](#example-arbitrary-number-unspecific-function-arb)
    - [Example: Interval (Non-function Symbols) `interval()`](#example-interval-non-function-symbols-interval)
- [Parser Generation](#parser-generation)
- [Location Information](#location-information)
- [Unparsing](#unparsing)
  - [Brackets](#brackets)
  - [Commutative collections](#commutative-collections)
  - [Substitution filtering](#substitution-filtering)
  - [Variable alpha renaming](#variable-alpha-renaming)
  - [Macro expansion](#macro-expansion)
  - [Formatting](#formatting)
    - [`format` attribute](#format-attribute)
    - [`color` and `colors` attributes](#color-and-colors-attributes)
- [Debugging](#debugging)
  - [The K Definition](#the-k-definition)
  - [Stepping](#stepping)
  - [Breaking on a specific rule](#breaking-on-a-specific-rule)
  - [Breaking on a function](#breaking-on-a-function)
  - [Breaking on a set of rules or functions](#breaking-on-a-set-of-rules-or-functions)
  - [Other debugger issues](#other-debugger-issues)
