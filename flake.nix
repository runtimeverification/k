{
  ...
  inputs = {
    ...
    haskell-backend.url = "github:runtimeverification/haskell-backend/1d7425fc6a7c34cf2eb8f6673edfb53b23566540";
    booster-backend = {
      url = "github:runtimeverification/hs-backend-booster/8cf091faf6fb6236b15fc462440bd658db6b2f57";
