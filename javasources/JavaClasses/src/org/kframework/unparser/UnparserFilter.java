...
public class UnparserFilter extends BasicVisitor {
    ...
    @Override
    public void visit(org.kframework.k.List list) {
	prepare(list);
	super.visit(list);
	postpare();
    }
    ...
    @Override
    public void visit(org.kframework.k.Map map) {
	prepare(map);
    ...
    @Override
    public void visit(org.kframework.k.Set set) {
	prepare(set);
	super.visit(set);
	postpare();
    }
    ...
    @Override
    public void visit(org.kframework.k.Ambiguity ambiguity) {
	prepare(ambiguity);
	result.endLine();
    ...
    @Override
    public void visit(org.kframework.k.Context context) {
	prepare(context);
    ...
    @Override
    public void visit(org.kframework.k.Require require) {
	prepare(require);
