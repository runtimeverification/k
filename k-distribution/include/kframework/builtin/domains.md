...
module SET-KORE-SYMBOLIC [kore,symbolic]
  ...
  // The rule below is automatically generated by the frontend for every sort
  // hooked to SET.Set. It is left here to serve as documentation.
  //todo Generalized #Ceil, implement in front-end once Haskell supports ML matching
  //See https://github.com/runtimeverification/haskell-backend/issues/3107
  /*rule #Ceil(@S1:Set @S2:Set) => {intersectSet(@S1, @S2) #Equals .Set} #And #Ceil(@S1) #And #Ceil(@S2)
    [anywhere, simplification]*/ 
    
  //simplified #Ceil, the actual rule generated by front-end at the moment
