...
public class OcamlOptions implements Serializable {
    ...
    @Parameter(names="--no-link-prelude", description="Do not link interpreter binaries against constants.cmx, prelude.cmx, plugin.cmx, lexer.cmx, parser.cmx, and run.cmx. Do not use this if you don't know what you're doing.")
