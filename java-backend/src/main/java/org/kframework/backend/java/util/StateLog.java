...
public class StateLog {
    ...
    public static enum LogEvent {
        OPEN, REACHINIT, REACHTARGET, REACHPROVED, REACHRESULT, EXECINIT, SEARCHINIT, SEARCHREACH, NODE, RULE, SRULE, RULEATTEMPT, SRULEATTEMPT, IMPLICATION, Z3QUERY, Z3RESULT, CLOSE, CHECKINGCONSTRAINT
    }
