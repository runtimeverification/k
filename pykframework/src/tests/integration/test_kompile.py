...
from pykframework.kast.inner import KSort
from pykframework.kore.syntax import SortApp
from pykframework.ktool.kompile import DefinitionInfo, KompileBackend, KompileNotFoundError, pykframeworkBackend, kompile
...
if TYPE_CHECKING:
    ...
    from pykframework.kast.inner import KLabel
...
def test_booster_kompile(tmp_path: Path) -> None:
    ...
    # When
    kompile(main_file, backend=pykframeworkBackend.BOOSTER, output_dir=output_dir)
