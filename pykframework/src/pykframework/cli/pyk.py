...
def create_argument_parser() -> ArgumentParser:
    ...
    pykframework_args = ArgumentParser()
    pykframework_args_command = pykframework_args.add_subparsers(dest='command', required=True)

    print_args = pykframework_args_command.add_parser(
        'print',
    ...
    rpc_print_args = pykframework_args_command.add_parser(
        'rpc-print',
    ...
    rpc_kast_args = pykframework_args_command.add_parser(
        'rpc-kast',
    ...
    prove_legacy_args = pykframework_args_command.add_parser(
        'prove-legacy',
    ...
    kompile_args = pykframework_args_command.add_parser(
        'kompile',
    ...
    kompilex_args = pykframework_args_command.add_parser(
        'kompilex',
        help='Kompile the K specification.',
        parents=[
            k_cli_args.logging_args,
    ...
    run_args = pykframework_args_command.add_parser(
        'run',
    ...
    prove_args = pykframework_args_command.add_parser(
        'prove',
    ...
    show_args = pykframework_args_command.add_parser(
        'show',
    ...
    graph_imports_args = pykframework_args_command.add_parser(
        'graph-imports',
    ...
    coverage_args = pykframework_args_command.add_parser(
        'coverage',
    ...
    pykframework_args_command.add_parser(
    ...
    parse_outer_args = pykframework_args_command.add_parser(
        'parse-outer',
