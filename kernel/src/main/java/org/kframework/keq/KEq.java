...
public class KEq {
    ...
    public int run(
        ...
        Tuple2<Definition, Module> compiled1 = new ProofDefinitionBuilder(def1, backend, files, kem, sw).build(
        ...
        Tuple2<Definition, Module> compiled2 = new ProofDefinitionBuilder(def2, backend, files, kem, sw).build(
