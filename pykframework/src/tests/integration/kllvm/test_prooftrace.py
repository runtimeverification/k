...
import pykframework.kllvm.hints.prooftrace as prooftrace
from pykframework.kllvm.parser import parse_definition
...
from pykframework.testing import ProofTraceTest
