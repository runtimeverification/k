...
public class TagFactory {
	...
	public static Tag createTag(Element element, Map<String, String> consMap) {
		...
		if (Constants.MODULEIMPORT_moduleImport_TAG.equals(element
				.getNodeName()))
		...
		if (Constants.DEFINE_define_TAG.equals(element.getNodeName()))
			return new DEFINE_define_TAG(element, consMap);
