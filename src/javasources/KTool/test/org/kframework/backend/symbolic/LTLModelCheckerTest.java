...
public class LTLModelCheckerTest {
    ...
    public void testSymbolicLTLStateRuleTransformer() {
        ...
        // LHS
        Variable inputLTLState = new Variable("B", Sort2.BAG);
        KApp inputLTLStateKApp = KApp.of(new KInjectedLabel(inputLTLState), KList.EMPTY);
        Variable X = new Variable("X", Sort2.of("Id"));
        Variable I = new Variable("I", Sort2.of("Int"));
        ...
        // LHS
        Variable phi = new Variable("GeneratedFreshVar0", Sort2.K);
