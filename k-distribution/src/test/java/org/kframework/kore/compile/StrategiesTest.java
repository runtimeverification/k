...
public class StrategiesTest {
    ...
    private void assertSearch(String filename, String mainModule, String syntaxModule, String pgm, String expected) throws URISyntaxException, IOException {
        KoreUtils utils = new KoreUtils(filename, mainModule, syntaxModule, true, false, KORE.Sort("Exp"));
        K kPgm = utils.getParsed(pgm, Source.apply("generated by " + getClass().getSimpleName()));
