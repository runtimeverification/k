...
public class BasicParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("Basic");
  ...
  { 
    BasicParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = BasicParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = BasicParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(BasicParseControllerGenerated.class);
    }
  ...
  { 
    return BasicParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
