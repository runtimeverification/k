...
//            syntax List ::= "#buffer" "(" K ")"           [cons(List1IOBufferSyn)]
            TermCons buffer = new TermCons(Sort.STREAM, "Stream1IOBufferSyn", context);
            java.util.List<Term> bufferTerms = new ArrayList<Term>();
            bufferTerms.add(new Variable("$stdin", Sort.STRING)); // eq stdinVariable = mkVariable('$stdin,K) .
...
//            syntax List ::= "#istream" "(" Int ")"        [cons(List1InputStreamSyn)]
            TermCons stdinStream = new TermCons(Sort.STREAM, "Stream1InputStreamSyn", context);
...
//            | "#ostream" "(" Int ")"        [cons(List1OutputStreamSyn)]
            TermCons stdoutStream = new TermCons(Sort.STREAM, "Stream1OutputStreamSyn", context);
            java.util.List<Term> stdinStreamTerms = new ArrayList<Term>();
