{
  ...
  inputs = {
    ...
    booster-backend = {
      url = "github:runtimeverification/hs-backend-booster/37cb498134a89071098c1b650771659f8abeb19e";
  ...
  outputs = { self, nixpkgs, flake-utils, rv-utils, haskell-backend, booster-backend
    ...
    in flake-utils.lib.eachSystem [
      ...
      in rec {
        ...
        devShells.kore-integration-tests = pkgs.kore-tests (pkgs.k-framework { inherit haskell-backend-bins; });
      }) // {
