...
public class TstKDebugOnKORE_IT {
    ...
    public void jumpBackTest() {
        ...
        debuggerSession.backStep(forward).getCurrentK();
    ...
    public void jumpCommandTest() {
        ...
        K debugResult = debuggerSession.jumpTo(stateNum).getCurrentK();
        K expectedResult = utils.stepRewrite(parsed, Optional.ofNullable(new Integer(stateNum)));
