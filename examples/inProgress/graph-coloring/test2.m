load graph-coloring-setup-compiled

search [1] in GRAPH-COLORING-SETUP : < top > 
 < k > 'setup(.List{K}) ~> 'start(.List{K}) ~> 'run(.List{K}) </ k > 
 < graphType > (.).K </ graphType > 
 < time > Int -1(.List{K}) </ time > 
 ...
 < cards > SetItem(String "A1"(.List{K})) SetItem(String "A2"(.List{K})) SetItem(String "B1"(.List{K})) SetItem(String "B2"(.List{K})) </ cards > 
