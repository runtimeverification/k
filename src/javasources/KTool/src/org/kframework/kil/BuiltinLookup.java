...
public abstract class BuiltinLookup extends Term implements Interfaces.Parent<Term, BuiltinLookup.Children> {
    ...
    /** {@link Sort2} representation of the the kind of the value returned by this lookup */
    private final Sort2 kind;
    ...
    protected BuiltinLookup(Variable base, Term key, Sort2 kind, boolean choice) {
        this.base = base;
        this.key = key;
        this.kind = kind;
        this.choice = choice;
