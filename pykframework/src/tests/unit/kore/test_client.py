...
from pykframework.kore.prelude import INT, SORT_GENERATED_TOP_CELL, int_dv
...
from pykframework.kore.syntax import And, App, Bottom, Equals, EVar, Module, Top
...
if TYPE_CHECKING:
    ...
    from pykframework.kore.rpc import ExecuteResult
...
def mock_class() -> Iterator[Mock]:
    patcher = patch('pykframework.kore.rpc.JsonRpcClient', spec=True)
    yield patcher.start()
    patcher.stop()
