...
public class K3SyntaxParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("K3Syntax");
  ...
  { 
    K3SyntaxParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = K3SyntaxParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = K3SyntaxParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(K3SyntaxParseControllerGenerated.class);
    }
  ...
  { 
    return K3SyntaxParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
