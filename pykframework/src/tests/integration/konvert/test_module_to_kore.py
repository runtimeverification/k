...
from pykframework.konvert import module_to_kore
from pykframework.kore.parser import KoreParser
from pykframework.kore.syntax import SortDecl, Symbol, SymbolDecl
from pykframework.ktool.kompile import DefinitionInfo
...
if TYPE_CHECKING:
    ...
    from pykframework.kore.syntax import Module, Sentence
