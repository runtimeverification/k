...
from pykframework.kore.prelude import int_dv
from pykframework.kore.rpc import KoreClient, SingleSocketTransport
...
def mock_class() -> Iterator[Mock]:
    patcher = patch('pykframework.kore.rpc.SingleSocketTransport', spec=True)
    yield patcher.start()
    patcher.stop()
