{
  ...
  inputs = {
    ...
    haskell-backend.url = "github:runtimeverification/haskell-backend/ca76acba35fefd694f7644a523a82907492c89fb";
    booster-backend = {
      url = "github:runtimeverification/hs-backend-booster/2db8106b9141f33210fa041489d80dc4cf8b53aa";
