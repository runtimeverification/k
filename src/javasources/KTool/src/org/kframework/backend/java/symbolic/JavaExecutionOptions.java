...
public final class JavaExecutionOptions {
    @Parameter(names="--generate-tests", description="Test programs will be generated along with normal search.")
    public boolean generateTests = false;
    
    @Parameter(names="--deterministic-functions", description="Throw assertion failure during execution in the java backend if function definitions are not deterministic.")
