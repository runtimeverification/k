...
public class ResolveFreshConfigConstants {
     ...
     *
     * There is a question of whether fresh config variables with the same name but in
     * different modules should generate different constants. For the sake of simplicity, and
     * to allow the use case, no distinction is made between different modules.
     *
     * @param r The rule that initializes the cell
     * @param body The KRewrite for the rule
     * @return The body is returned with any fresh variables in the RHS replaced with a
     *         fresh constant
     */
     ...
     *
     * This is used in the next stage of the pipeline where the generatedCounter cell is added
     * to the configuration. The initializer rule for the generatedCounter will use this value
     * so any fresh values during execution do not conflict with the values in the initial
     * configuration.
     *
