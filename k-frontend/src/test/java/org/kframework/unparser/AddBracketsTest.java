...
public class AddBracketsTest {
  ...
  private Module parseModule(String def) {
    return ParserUtils.parseMainModuleOuterSyntax(
        def, Source.apply("generated by AddBracketsTest"), "TEST");
  }
  ...
  private void unparserTest(String def, String pgm) {
    ...
    ParseInModule parser =
        RuleGrammarGenerator.getCombinedGrammar(gen.getProgramsGrammar(test), files);
