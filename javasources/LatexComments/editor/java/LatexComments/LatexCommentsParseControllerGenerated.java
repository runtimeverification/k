...
public class LatexCommentsParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("LatexComments");
  ...
  { 
    LatexCommentsParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = LatexCommentsParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = LatexCommentsParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(LatexCommentsParseControllerGenerated.class);
    }
  ...
  { 
    return LatexCommentsParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
