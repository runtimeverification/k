...
from pykframework.kast import EMPTY_ATT
from pykframework.kast.manip import remove_generated_cells
from pykframework.kast.outer import KDefinition, KRequire
from pykframework.kast.pretty import paren
...
if TYPE_CHECKING:
    from pykframework.kast.outer import KFlatModule
