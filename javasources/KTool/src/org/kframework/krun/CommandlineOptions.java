...
public class CommandlineOptions {
	...
	public void initializeDebugOptions() {
		...
		Option select = OptionBuilder.hasArg(true).withArgName("number").withLongOpt("select").withDescription("Select the current configuration after a search result using step-all command").create();
