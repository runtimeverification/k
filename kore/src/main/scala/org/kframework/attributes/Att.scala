...
object Att {
  ...
  final val NOT_LR1 = Key("not-lr1", KeyType.BuiltIn, KeyParameter.Optional)
   ...
   */
  final val ANONYMOUS = Key("anonymous", KeyType.Internal, KeyParameter.Forbidden)
  final val BRACKET_LABEL = Key("bracketLabel", KeyType.Internal, KeyParameter.Required)
  final val CELL_FRAGMENT = Key("cellFragment", KeyType.Internal, KeyParameter.Required)
  final val CELL_OPT_ABSENT = Key("cellOptAbsent", KeyType.Internal, KeyParameter.Required)
  final val CELL_SORT = Key("cellSort", KeyType.Internal, KeyParameter.Forbidden)
  final val CONCAT = Key("concat", KeyType.Internal, KeyParameter.Required)
  final val CONTENT_START_COLUMN = Key("contentStartColumn", KeyType.Internal, KeyParameter.Required)
  final val CONTENT_START_LINE = Key("contentStartLine", KeyType.Internal, KeyParameter.Required)
  final val COOL_LIKE = Key("cool-like", KeyType.Internal, KeyParameter.Forbidden)
  final val DENORMAL = Key("denormal", KeyType.Internal, KeyParameter.Required)
  final val DIGEST = Key("digest", KeyType.Internal, KeyParameter.Required)
  final val DUMMY_CELL = Key("dummy_cell", KeyType.Internal, KeyParameter.Forbidden)
  final val FILTER_ELEMENT = Key("filterElement", KeyType.Internal, KeyParameter.Forbidden)
  ...
  final val ORIGINAL_PRD = Key("originalPrd", KeyType.Internal, KeyParameter.Required)
  final val PATTERN = Key("pattern", KeyType.Internal, KeyParameter.Forbidden)
  final val PATTERN_FOLDING = Key("pattern-folding", KeyType.Internal, KeyParameter.Forbidden)
  ...
  final val RECORD_PRD_ZERO = Key("recordPrd-zero", KeyType.Internal, KeyParameter.Forbidden)
  final val RECORD_PRD_ONE = Key("recordPrd-one", KeyType.Internal, KeyParameter.Required)
  final val RECORD_PRD_MAIN = Key("recordPrd-main", KeyType.Internal, KeyParameter.Forbidden)
  final val RECORD_PRD_EMPTY = Key("recordPrd-empty", KeyType.Internal, KeyParameter.Forbidden)
  final val RECORD_PRD_SUBSORT = Key("recordPrd-subsort", KeyType.Internal, KeyParameter.Forbidden)
  final val RECORD_PRD_REPEAT = Key("recordPrd-repeat", KeyType.Internal, KeyParameter.Forbidden)
  final val RECORD_PRD_ITEM = Key("recordPrd-item", KeyType.Internal, KeyParameter.Required)
  final val REFRESHED = Key("refreshed", KeyType.Internal, KeyParameter.Required)
  final val REGEX = Key("regex", KeyType.Internal, KeyParameter.Forbidden)
  ...
  final val UNIQUE_ID = Key("UNIQUE_ID", KeyType.Internal, KeyParameter.Required)
  final val USER_LIST = Key("userList", KeyType.Internal, KeyParameter.Required)
  final val USER_LIST_TERMINATOR = Key("userListTerminator", KeyType.Internal, KeyParameter.Required)
  final val WITH_CONFIG = Key("withConfig", KeyType.Internal, KeyParameter.Forbidden)
