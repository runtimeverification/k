        ...
        return new RewriteAwareTransformer(true) {
            ...
            public K apply(KApply k) {
                ...
                if (attributes.contains(Att.COMM())) {
                    ...
                    kem.addKException(new KException(KException.ExceptionType.ERROR, KException.KExceptionGroup.COMPILER,
                            "Used 'comm' attribute on simplification rule but " + k.klabel().name() + " is not comm.",
