...
to all people who download K, please do not hesitate to contact us at
...
appropriate citations to the inventor of the language; otherwise, since
your name appears as the author of the K definition, other users may
...
3) Make an effort to not exceed 80 characters per line.  Even though most
editors are able to smoothly deal with long lines, some editors are not.
Moreover, some people look at definitions by browsing the svn repository
with a browser; long lines look bad in a browser.
