 ...
 *
 * <p>The main complexity here is eliminating cell fragment variables that might capture multiple
...
public class SortCellsTest {
  ...
  LabelInfo labelInfo =
      new LabelInfo() {
        {
          addLabel(Sort("TopCell"), "<top>");
          addLabel(Sort("ThreadCell"), "<t>");
          addLabel(Sort("KCell"), "<k>");
          addLabel(Sort("EnvCell"), "<env>");
          addLabel(Sort("OptCell"), "<opt>");
        }
      };
  ...
  public void testAddOptCell() {
    ...
    K expected =
        cell(
            ...
            KVariable("_Gen0"),
            KVariable("_Gen1"),
            KRewrite(KApply(KLabel(".OptCell")), cell("<opt>")));
    KExceptionManager kem = new KExceptionManager(new GlobalOptions());
    Assert.assertEquals(expected, new SortCells(cfgInfo, labelInfo).sortCells(term));
    Assert.assertEquals(0, kem.getExceptions().size());
  }
  ...
  public void testRemoveOptCell() {
    ...
    K expected =
        cell(
            ...
            KVariable("_Gen0"),
            KVariable("_Gen1"),
            KRewrite(cell("<opt>"), KApply(KLabel(".OptCell"))));
    KExceptionManager kem = new KExceptionManager(new GlobalOptions());
    Assert.assertEquals(expected, new SortCells(cfgInfo, labelInfo).sortCells(term));
    Assert.assertEquals(0, kem.getExceptions().size());
  }
  ...
  public void testConcatStarCell() {
    K term =
        cell("<top>", KRewrite(KVariable("Y"), cells(KVariable("Y"), cell("<t>", KVariable("X")))));
    K expected =
        cell(
            "<top>",
            KRewrite(
  ...
  public void testFragment2() {
    K term =
        cell(
            "<top>",
            cell("<t>", cell("<k>", KVariable("K")), KVariable("F")),
            cell(
                "<t>",
                cell(
                    "<k>",
  ...
  public void testFragment3() {
    K term =
        cell(
            "<top>",
            cell("<t>", cell("<opt>", KVariable("O")), KVariable("F")),
            cell(
                "<t>",
                cell(
                    "<k>",
  ...
  public void testFragment4() {
    K term =
        cell(
            "<top>",
            cell("<t>", cell("<env>", KVariable("E")), KVariable("F")),
            cell(
                "<t>",
                cell(
                    "<k>",
  ...
  public void testFragmentBag() {
    K term =
        cell(
            "<top>",
            KVariable("F"),
            cell("<t>", KRewrite(KVariable("Rest"), KSequence(KVariable("F"), KVariable("Rest")))));
    K expected =
        cell(
            "<top>",
            app(
                ...
                cell(
                    ...
                    KRewrite(
                        KVariable("Rest"),
                        KSequence(
                            app("<top>-fragment", KVariable("_Gen0"), KVariable("_Gen1")),
                            KVariable("Rest"))))),
            KVariable("_Gen1"));
    KExceptionManager kem = new KExceptionManager(new GlobalOptions());
  ...
  public void testFragmentRewrite() {
    K term =
        cell(
            "<top>",
            cell("<t>", KRewrite(app("restore", KVariable("Ctx")), KVariable("Result"))),
            KRewrite(
                cells(KVariable("_Gen1"), cell("<t>", KVariable("Result"))), KVariable("Ctx")));
    K expected =
        cell(
            "<top>",
            app(
                ...
                cell(
                    ...
                    KRewrite(
                        app(
                            "restore",
                            app("<top>-fragment", KVariable("_Gen0"), KVariable("_Gen2"))),
                        KVariable("Result"))),
                KRewrite(
                    app("_ThreadCellBag_", KVariable("_Gen3"), cell("<t>", KVariable("Result"))),
                    KVariable("_Gen0"))),
   ...
   * which applies the sort predicate for a <em>different</em> cell fragment sort to a cell fragment
   * variable.
   */
  @Test
