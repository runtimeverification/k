 ...
 *
 * It's a thin wrapper around a HashSet, which really makes me wish
    ...
    for(Term t : contents){
      if(t instanceof SetItem){
        ...
        throw new MatchCompilationException(
            "Trying to convert a Set which contains a non-SetItem to a SetImpl. "
          + "SetImpl can only be created from ground Sets. Set was: " + s);
      }
    }
