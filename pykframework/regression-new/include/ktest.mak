...
KOMPILE=$(POETRY_RUN) pykframework kompile
# ditto for krun
KRUN=$(POETRY_RUN) pykframework run
# and kdep
KDEP=$(POETRY_RUN) pykframework kdep
# and kprove
KPROVE=$(POETRY_RUN) pykframework prove
# and kast
KAST=$(POETRY_RUN) pykframework parse
# and kparse
KPARSE=$(POETRY_RUN) pykframework parse
# and kserver
KSERVER=$(POETRY_RUN) pykframework kserver
# and ksearch
KSEARCH:=$(KRUN) --search-all
# and kprint
KPRINT=$(POETRY_RUN) pykframework parse
# and llvm-krun
LLVM_KRUN=$(POETRY_RUN) pykframework llvm-krun
