...
module STRATEGY
    ...
    syntax Strategy ::= #STUCK()    [symbol(#STUCK)]
                      | "^" #RuleTag [symbol(#applyRule)]
                      | "~" #RuleTag [symbol(#appliedRule)]
...
module STRATEGY-ABSTRACT
 ...
 // ------------------------------------------------
    ...
    syntax #RuleTag ::= #RuleTag "|" #RuleTag [left, symbol(#alternateRule)]
 // ------------------------------------------------------------------------
    rule <s> ^ RT:#RuleTag | RT':#RuleTag => ^ RT ~> #catchSTUCK(^ RT') ... </s>

    syntax #RuleTag ::= #RuleTag "*" [symbol(#repeatRule)]
 // ------------------------------------------------------
