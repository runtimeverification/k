...
public class K3DisambParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("K3Disamb");
  ...
  { 
    K3DisambParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = K3DisambParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = K3DisambParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(K3DisambParseControllerGenerated.class);
    }
  ...
  { 
    return K3DisambParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
